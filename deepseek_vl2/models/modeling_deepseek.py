...
from shallow_mla import fused_qk_attention, fused_apply_rotary_emb, fused_rms_norm, fused_mask_softmax
...
# MLA with Triton kernel optimization
class DeepseekV2AttentionTriton(nn.Module):
    """Multi-headed attention from 'Attention Is All You Need' paper"""
    ...
    def forward(
        ...
        **kwargs,
        ...
        compressed_kv = fused_rms_norm(
            compressed_kv, (compressed_kv.shape[-1],), 
        ...
        cos, sin = self.rotary_emb(q_pe, seq_len=kv_seq_len)
        # TODO: write a new kernel for apply_rotary_pos_emb
        q_pe, k_pe = apply_rotary_pos_emb(q_pe, k_pe, cos, sin, position_ids)
